        ...
        <div className={styles.gridContainer}>
          ...
          <div className={styles.contentContainer}>
            ...
            <p className={styles.description}>
              Nestled in the pristine coastal region of Ratnagiri, Maharashtra,
              our farms have been nurturing the finest Alphonso mangoes for
              generations. We take pride in continuing a legacy of sustainable
              farming practices that respect both tradition and nature.
            </p>
